          ...
          <tr>
            <td style="padding:40px;">
                ...
                <tr>
                  <td style="padding:20px 24px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr><td style="padding:6px 0;font-size:13px;color:#94a3b8;width:90px;">Soubor:</td><td style="padding:6px 0;font-size:13px;color:#0f172a;font-weight:500;">${file_name}</td></tr>
                    </table>
                  </td>
                </tr>
              </table>
              ...
              <p style="margin:0;font-size:13px;color:#94a3b8;line-height:1.6;">
                V případě jakýchkoli dotazů nás neváhejte kontaktovat na <a href="mailto:autoskolakubon@gmail.com" style="color:#2563eb;text-decoration:none;font-weight:500;">autoskolakubon@gmail.com</a> nebo na čísle <a href="tel:+420774277865" style="color:#2563eb;text-decoration:none;font-weight:500;">774 277 865</a>.
              </p>
            </td>
          </tr>
          <tr>
